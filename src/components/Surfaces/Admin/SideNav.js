    ...
    return (
        ...
        <Drawer variant="permanent" open={open}>
            ...
            <List>
                ...
                <ListItem disablePadding sx={{ display: 'block' }} onClick={() => {navigate("memberships")}}>
                    <ListItemButton
                        sx={{
                        minHeight: 48,
                        justifyContent: open ? 'initial' : 'center',
                    ...
                    >
                        ...
                        <ListItemText primary="Membresías" sx={{ opacity: open ? 1 : 0 }} />
                    </ListItemButton>
                </ListItem>

                <ListItem disablePadding sx={{ display: 'block' }} onClick={() => {navigate("subscriptions")}}>
                    <ListItemButton
                        sx={{
                        minHeight: 48,
                        justifyContent: open ? 'initial' : 'center',
                    ...
                    >
                        ...
                        <ListItemText primary="Suscripciones" sx={{ opacity: open ? 1 : 0 }} />
                    </ListItemButton>
                </ListItem>
            </List>
        </Drawer>
